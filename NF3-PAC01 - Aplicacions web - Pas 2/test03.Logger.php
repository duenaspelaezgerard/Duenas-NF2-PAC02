...
$log->logMessage('Postres logger test debug.', $className::DEBUG);
$log->logMessage('Postres logger test info.', $className::INFO);
$log->logMessage('Postres logger test warning.', $className::WARNING);
