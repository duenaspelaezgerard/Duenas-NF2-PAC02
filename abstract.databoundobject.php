...
abstract class DataBoundObject {
   ...
   public function Load() {     
      ...
      if (isset($this->ID)) {
      logMessage(" VOY A SELECCIONAR ESTE ID " .$this->ID, 50);
		$strQuery = "SELECT ";
   ...
   public function Save() {
      ...
      if (isset($this->ID)) {
         logMessage(" VOY A GUARDAR ESTE ID" .$this->ID, 50);
   ...
   public function __destruct() {
      if (isset($this->ID)) {   
         if ($this->blForDeletion == true) {
            logMessage(" VOY A SELECCIONAR PARA DESTRUIR ESTE ID" .$this->ID, 50);
   ...
   private function SetAccessor($strMember, $strNewValue) {
      ...
      if (property_exists($this, $strMember)) {
         logMessage(" VOY A DECLARAR ESTO " .$strNewValue, 50);
   ...
   private function GetAccessor($strMember) {
      ...
      if (property_exists($this, $strMember)) {
         logMessage(" VOY A OBTENER ESTO " .$strMember, 50);
